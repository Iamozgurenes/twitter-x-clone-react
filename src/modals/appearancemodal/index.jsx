        ...
        <div className="w-[600px]">
            ...
            <div className="p-8 pt-0">
                ...
                <div className="py-2 px-4 mb-3 grid grid-cols-3 gap-2 bg-[color:var(--background-secondary)] rounded-2xl">
                    ...
                    className={classNames("h-[62px] pr-3 pl-2 bg-white text-[#0f1419] font-bold border border-black/5 rounded group flex items-center gap-1.5", {"!border-[color:var(--color-primary)] !border-2": backgroundColor.name === 'light'})}>
                       
                       <div className="w-[40px] h-[40px] rounded-full flex-shrink-0 group-hover:bg-white/10 flex items-center justify-center">
                            <div className={classNames("w-[20px] h-[20px] rounded-full border-[2px] border-[#b9cad3] flex items-center justify-center" , {"!border-[color:var(--color-primary)] !bg-[color:var(--color-primary)] text-white": backgroundColor.name === 'light'})}>
                    ...
                    className={classNames("h-[62px] pr-3 pl-2 bg-[#15202b] text-[#f7f9f9] font-bold border border-white/10 rounded group flex items-center gap-1.5", {"!border-[color:var(--color-primary)] !border-2" : backgroundColor.name === 'dark'})}>
                    
                    <div className="w-[40px] h-[40px] rounded-full flex-shrink-0 group-hover:bg-white/5 flex items-center justify-center">
                            <div className={classNames("w-[20px] h-[20px] rounded-full  border-[2px] border-[#5c6e7e] flex items-center justify-center" , {"!border-[color:var(--color-primary)] !bg-[color:var(--color-primary)] text-white": backgroundColor.name === 'dark'})}>
                    ...
                    className={classNames("h-[62px] pr-3 pl-2 bg-black text-[#f7f9f9] font-bold border border-white/10 rounded group flex items-center gap-1.5" , {"!border-[color:var(--color-primary)] !border-2" : backgroundColor.name === 'darker'})}>
                        
                        <div className="w-[40px] h-[40px] rounded-full flex-shrink-0 group-hover:bg-white/10 flex items-center justify-center">
                            <div className={classNames("w-[20px] h-[20px] rounded-full border-[2px] border-[#3e4144] flex items-center justify-center" , {"!border-[color:var(--color-primary)] !bg-[color:var(--color-primary)] text-white": backgroundColor.name === 'darker'})}>
