...
export default function Footer() {
    return (
        <footer className="mb-4 px-4 flex flex-wrap gap-2">
          ...
          <Popover.Panel className="w-[150px] max-[384px] bg-black rounded-xl absolute shadow-box bottom-0 right-0: grid overflow-hidden">
          ...
          <p className="text-[#71767b] leading-4 text-[13px]"> &copy; / OZGUR-ENES </p>
            </div>
