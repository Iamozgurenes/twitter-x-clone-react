...
export default function Footer() {
    return (
        <footer className="mb-4 px-4 flex flex-wrap gap-2  text-[0.813rem]">
          ...
          <Popover.Panel className="w-[9.375rem] max-[24rem] bg-[color:var(--background-secondary)] rounded-xl absolute shadow-box bottom-0 right-0: grid overflow-hidden ">
          ...
          <p className="text-[color:var(--color-base-secondary)] leading-4 "> &copy; / OZGUR-ENES </p>
            </div>
