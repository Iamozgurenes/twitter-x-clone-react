    ...
    <h5 className="py-3 px-4 text-xl font-extrabold leading-6 flex items-center "> 
     ...
     <div className="grid">
        ...
        {more && (
            ...
            <Link to={more} className="h-[3.25rem] flex rounded-b-2xl items-center px-4  text-[color:var(--color-primary)] transition-colors hover:bg-[color:var(--background-third)]">
            Daha fazla göster
        </Link>
        )}
