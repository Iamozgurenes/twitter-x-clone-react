...
export const mainMenu = [
    ...
    icon: {
        ...
        passive: (
            <svg viewBox="0 0 24 24" width={26.25} height={26.25}>
            <path fill="#fff" d="M21.591 7.146L12.52 1.157c-.316-.21-.724-.21-1.04 0l-9.071 5.99c-.26.173-.409.456-.409.757v13.183c0 .502.418.913.929.913h6.638c.511 0 .929-.41.929-.913v-7.075h3.008v7.075c0 .502.418.913.929.913h6.639c.51 0 .928-.41.928-.913V7.904c0-.301-.158-.584-.408-.758zM20 20l-4.5.01.011-7.097c0-.502-.418-.913-.928-.913H9.44c-.511 0-.929.41-.929.913L8.5 20H4V8.773l8.011-5.342L20 8.764z"/>
                </svg>
        )
    }
  },
...
<path fill="#fff" d="M11.996 2c-4.062 0-7.49 3.021-7.999 7.051L2.866 18H7.1c.463 2.282 2.481 4 4.9 4s4.437-1.718 4.9-4h4.236l-1.143-8.958C19.48 5.017 16.054 2 11.996 2zM9.171 18h5.658c-.412 1.165-1.523 2-2.829 2s-2.417-.835-2.829-2z"/>                  </svg>
  ...
  },
  {
    ...
    icon: {
        active: (
            <svg viewBox="0 0 24 24" width={26.25} height={26.25}>
                <path fill="#e7e9ea" d="M1.998 4.499c0-.828.671-1.499 1.5-1.499h17c.828 0 1.5.671 1.5 1.499v2.858l-10 4.545-10-4.547V4.499zm0 5.053V19.5c0 .828.671 1.5 1.5 1.5h17c.828 0 1.5-.672 1.5-1.5V9.554l-10 4.545-10-4.547z"/>
                  </svg>
        ),
        passive: (
            <svg viewBox="0 0 24 24" width={26.25} height={26.25}>
  ...
  },
  {
    ...
    icon: {
        active: (
            <svg viewBox="0 0 24 24" width={26.25} height={26.25}>
                <path fill="#fff" d="M18.5 2h-13C4.12 2 3 3.12 3 4.5v15C3 20.88 4.12 22 5.5 22h13c1.38 0 2.5-1.12 2.5-2.5v-15C21 3.12 19.88 2 18.5 2zM16 14H8v-2h8v2zm0-4H8V8h8v2z"/>
                  </svg>
        ),
        passive: (
            <svg viewBox="0 0 24 24" width={26.25} height={26.25}>
  ...
  },
  {
    ...
    icon: {
        active: (
            <svg viewBox="0 0 24 24" width={26.25} height={26.25}>
                <path fill="#fff" d="M4 4.5C4 3.12 5.119 2 6.5 2h11C18.881 2 20 3.12 20 4.5v18.44l-8-5.71-8 5.71V4.5z"/>
                  </svg>
        ),
        passive: (
            <svg viewBox="0 0 24 24" width={26.25} height={26.25}>
...

  {
    ...
    icon: {
        active: (
            <svg viewBox="0 0 24 24" width={26.25} height={26.25}>
                <path fill="#fff" d="M17.863 13.44c1.477 1.58 2.366 3.8 2.632 6.46l.11 1.1H3.395l.11-1.1c.266-2.66 1.155-4.88 2.632-6.46C7.627 11.85 9.648 11 12 11s4.373.85 5.863 2.44zM12 2C9.791 2 8 3.79 8 6s1.791 4 4 4 4-1.79 4-4-1.791-4-4-4z"/>
                  </svg>
        ),
        passive: (
            <svg viewBox="0 0 24 24" width={26.25} height={26.25}>
